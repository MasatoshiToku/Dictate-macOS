...
final class GeminiServiceManager: Sendable {
    ...
    static let instance = GeminiServiceManager()
    ...
    static func validateApiKey(_ apiKey: String) async -> (valid: Bool, error: String?) {
