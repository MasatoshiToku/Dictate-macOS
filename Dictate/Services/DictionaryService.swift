...
final class DictionaryService: @unchecked Sendable {
    ...
    func getByCategory(_ category: DictionaryEntry.DictionaryCategory) -> [DictionaryEntry] {
        lock.lock()
        defer { lock.unlock() }
    ...
    @discardableResult
    func addEntry(reading: String, word: String, category: DictionaryEntry.DictionaryCategory) throws -> DictionaryEntry {
        lock.lock()
        defer { lock.unlock() }
    ...
    func updateEntry(id: String, reading: String? = nil, word: String? = nil) -> Bool {
        lock.lock()
        defer { lock.unlock() }
