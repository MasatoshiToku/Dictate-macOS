...
final class AudioRecorderService: ObservableObject {
    ...
    private func buildWAVData() throws -> Data {
        ...
        do {
            return try createWAVFile(pcmData: pcmData, sampleRate: Int(targetSampleRate), channels: Int(targetChannels))
        } catch {
            throw AudioRecorderError.wavWriteFailed(error)
        }
    }
    ...
    private func createWAVFile(pcmData: Data, sampleRate: Int, channels: Int) throws -> Data {
